...
namespace Oracle.Dapper.NetCore.Dapper
{
    public class DapperFeatures : IDapperFeatures
    {
        ...
        public Task<DbDataReader> ExecuteReaderWithReturnDbDataReaderAsync(CommandDefinition command) =>
            ((DbConnection)_connection).ExecuteReaderAsync(command);

        public Task<IDataReader> ExecuteReaderAsync(CommandDefinition command) =>
            _connection.ExecuteReaderAsync(command);

        public Task<DbDataReader> ExecuteReaderWithReturnDbDataReaderAsync(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
            ((DbConnection)_connection).ExecuteReaderAsync(sql, param, transaction, commandTimeout, commandType);
        ...
        public Task<DbDataReader> ExecuteReaderWithReturnDbDataReaderAsync(CommandDefinition command, CommandBehavior commandBehavior) =>
            ((DbConnection)_connection).ExecuteReaderAsync(command, commandBehavior);
